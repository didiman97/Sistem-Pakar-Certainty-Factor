...
Public Class LapporanDiagnosa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemPakarWilliamSyndrome.LapporanDiagnosa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapporanDiagnosa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapporanDiagnosa = New LapporanDiagnosa
        rpt.Site = Me.Site
        Return rpt
    End Function
