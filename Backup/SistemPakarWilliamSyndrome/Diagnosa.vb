...
Public Class Diagnosa
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Dim namaanak As String = InputBox("Masukkan Nama Anak Anda")
        If namaanak = "" Then
            namaanak = InputBox("Masukkan Nama Anak Anda")
                                        ...
                                        Using Data1 As OleDbDataReader = cmd1.ExecuteReader
                                            While Data1.Read
                                                ...
                                                Using koneksi2 As New OleDbConnection(Skripsi)
                                                    Using cmd2 As New OleDbCommand("select * from Rule where Kd_Gejala= '" & Kd_Gejala & "' and Kd_Penyakit='" & Penyakit & "'", koneksi2)
                                                        koneksi2.Open()
