...
Public Class Rule
    Sub TampilData()
        ...
        Using koneksi As New OleDbConnection(Skripsi)
            Using cmd As New OleDbCommand("select * from Basis_Pengetahuan", koneksi)
                koneksi.Open()
                Using Data As OleDbDataReader = cmd.ExecuteReader
                    ...
                    While Data.Read
                        ...
                        ListView1.Items(x).SubItems.Add(Data("cf"))
    ...
    Private Sub batal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles batal.Click
        ...
        Else
            Try
                Using Koneksi As New OleDbConnection(Skripsi)
                    Using Cmd As New OleDbCommand("update Basis_Pengetahuan set Kd_Penyakit='" & ComboBox1.Text & _
    ...
    Private Sub tutup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Close()
    ...
    Private Sub simpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles simpan.Click
        ...
        Else
            Try
                ...
                Using koneksi As New OleDbConnection(Skripsi)
                    Using Cmd As New OleDbCommand("insert into Basis_Pengetahuan values('" & _
                                                  TextBox1.Text & "','" & _
                                                  ComboBox1.Text & "','" & _
                                                  ComboBox2.Text & "','" & _
                                                  TextBox4.Text & "','" & _
    ...
    Private Sub hapus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles hapus.Click
        ...
        Else
            ...
            If konfirmasi = vbYes Then
                Try
                    Using Koneksi As New OleDbConnection(Skripsi)
                        Using Cmd As New OleDbCommand("delete * from Basis_Pengetahuan where Kodepengetahuan='" & TextBox1.Text & "'", Koneksi)
                            Koneksi.Open()
                            Cmd.CommandType = CommandType.Text
                            Cmd.ExecuteNonQuery()
                        End Using
